...
/**
 * Renderer for a UIInput Hidden.
 */
public class InputHiddenRenderer extends com.sun.faces.renderkit.html_basic.HiddenRenderer {
    ...
    protected void getEndTextToRender(FacesContext context, UIComponent component, String currentValue, StringBuffer buffer) {
        // Simply render name and value
        buffer.append(XmlRenderKitUtils.getStartElement("input_hidden"));
