...
public class XFormsEventFactory {
    ...
    static {
        ...
        nameToClassMap.put(XFormsEvents.XXFORMS_VALUE, new Factory() {
            public XFormsEvent createEvent(XFormsContainingDocument containingDocument, String eventName, XFormsEventTarget targetObject, boolean allowCustomEvents, boolean bubbles, boolean cancelable, String contextString, Element contextElement, Throwable contextThrowable, Map<String, String> parameters) {
                return new XXFormsValue(containingDocument, targetObject, contextString);
            }
        });
    ...
    public static XFormsEvent createEvent(XFormsContainingDocument containingDocument, String eventName, XFormsEventTarget targetObject, boolean allowCustomEvents, boolean bubbles, boolean cancelable,
        ...
        return createEvent(containingDocument, eventName, targetObject, allowCustomEvents, bubbles, cancelable, contextString, null, null, parameters);
    }

    private static XFormsEvent createEvent(XFormsContainingDocument containingDocument, String eventName, XFormsEventTarget targetObject, boolean allowCustomEvents, boolean bubbles, boolean cancelable,
        ...
        if (factory == null) {
            ...
            return factory.createEvent(containingDocument, eventName, targetObject, allowCustomEvents, bubbles, cancelable, contextString, contextElement, contextThrowable, parameters);
        }
    }
    ...
    private static abstract class Factory {
        public abstract XFormsEvent createEvent(XFormsContainingDocument containingDocument, String eventName, XFormsEventTarget targetObject,
