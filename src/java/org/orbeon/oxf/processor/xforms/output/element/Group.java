...
public class Group extends XFormsElement {
    ...
    public void end(XFormsElementContext context, String uri, String localname, String qname) throws SAXException {
        if (isFirstGroup) {
            ...
            final Document instance = context.getCurrentInstance().getDocument();
            ...
            XFormsUtils.removeInstanceAttributes(context.getCurrentInstance().getDocumentInfo());
            String instanceString = XFormsUtils.encodeXML(context.getPipelineContext(), instance, false);
