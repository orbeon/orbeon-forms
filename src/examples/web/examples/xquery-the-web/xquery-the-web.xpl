...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <p:choose href="#request">
        <p:when test="/request/parameters/parameter[name = 'xquery']">
            <!-- Inline XQuery request -->
        ...
        <p:otherwise>
            ...
            <p:processor name="oxf:xslt">
                <p:input name="data" href="#request#xpointer(/request/parameters/parameter[name = 'xquery-url']/value)"/>
                <p:input name="config">
                    <config xsl:version="2.0">
