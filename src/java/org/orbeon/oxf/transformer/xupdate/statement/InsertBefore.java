...
public class InsertBefore extends Statement {
    ...
    public InsertBefore(LocationData locationData, String select, NamespaceContext namespaceContext, Statement[] statements) {
        super(locationData);
        this.select = select;
    ...
    public Object execute(URIResolver uriResolver, Object context, VariableContextImpl variableContext, DocumentContext documentContext) {
        ...
        Utils.insert(getLocationData(), insertPivot.getParent(), insertPivot.getParent().indexOf(insertPivot),
