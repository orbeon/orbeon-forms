...
public class PortletRequestDispatcherImpl implements PortletRequestDispatcher {
    ...
    public void include(RenderRequest request, RenderResponse response)
        ...
        try {
            requestDispatcher.include(new RequestWrapper(portletConfig, request, response, pathInfo, queryString), new ResponseWrapper(request, response));
...
class RequestWrapper implements HttpServletRequest {
    ...
    public RequestWrapper(PortletConfigImpl portletConfig, RenderRequest request, RenderResponse response, String pathInfo, String queryString) {
...
class ResponseWrapper implements HttpServletResponse {
    ...
    public ResponseWrapper(RenderRequest request, RenderResponse response) {
        this._request = request;
