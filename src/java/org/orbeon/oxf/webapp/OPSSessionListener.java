 ...
 */
public class OPSSessionListener implements HttpSessionListener {
    ...
    private void initializeDelegate(WebAppExternalContext webAppExternalContext) {
        try {
            if (httpSessionListenerDelegate == null) {
                Class delegateServletClass = OXFClassLoader.getClassLoader(webAppExternalContext).loadClass(OPSSessionListener.class.getName() + OXFClassLoader.DELEGATE_CLASS_SUFFIX);
