...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/">
        <!-- NOTE: the YUI class yui-skin-sam actually doesn't have effect when placed here -->
        <xhtml:div class="orbeon-portlet-div yui-skin-sam">
