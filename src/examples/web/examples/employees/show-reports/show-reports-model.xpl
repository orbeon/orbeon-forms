...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <p:processor name="oxf:pipeline">
        <p:input name="config" href="../data-access/find-employee.xpl"/>
        <p:input name="query" href="aggregate('query', #instance#xpointer(/*/employee-id))"/>
        <p:output name="data" id="employee"/>
    </p:processor>

    <p:processor name="oxf:pipeline">
        <p:input name="config" href="../data-access/find-employee-reports.xpl"/>
        <p:input name="query" href="aggregate('query', #instance#xpointer(/*/employee-id))"/>
        <p:output name="data" id="employee-reports"/>
    </p:processor>

    <p:processor name="oxf:identity">
        <p:input name="data" href="aggregate('root', #employee, #employee-reports)"/>
