...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <!-- Read XML source if needed -->
    <p:choose href="#instance">
        <p:when test="/*/source-url != ''">
            <!-- Read example descriptor from the particular example's directory -->
            <p:processor name="oxf:xslt">
                <p:input name="data" href="#instance"/>
                <p:input name="config">
            ...
            <p:choose href="#instance">
                ...
                <p:otherwise>
                    <p:processor name="oxf:xslt">
                        <p:input name="data" href="#source-file"/>
                        <p:input name="config" href="oxf:/inspector/formatter.xsl"/>
                        <p:output name="data" id="source"/>
                    </p:processor>
                </p:otherwise>
            </p:choose>
    ...
    <p:processor name="oxf:identity">
        <p:input name="data" href="aggregate('root', #example-descriptor, #instance, #source)"/>
