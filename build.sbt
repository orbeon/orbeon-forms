...
lazy val formRunnerJVM = formRunner.jvm
  ...
  .settings(
    ...
    libraryDependencies += "jakarta.servlet"      % "jakarta.servlet-api"       % JakartaServletApiVersion % Provided,
    libraryDependencies += "javax.portlet"        % "portlet-api"               % PortletApiVersion        % Provided,
    libraryDependencies += "org.wildfly.security" % "wildfly-elytron-http-oidc" % "2.8.3.Final"            % Provided,
...
lazy val dbToS3AttachmentMigration = (project in file("tools/db-to-s3-attachment-migration"))
  ...
  .settings(
    ...
    libraryDependencies                 += "com.ibm.db2"              % "jcc"                  % "12.1.3.0"     % DatabaseTest,
    libraryDependencies                 += "com.microsoft.sqlserver"  % "mssql-jdbc"           % "12.8.2.jre11" % DatabaseTest,
