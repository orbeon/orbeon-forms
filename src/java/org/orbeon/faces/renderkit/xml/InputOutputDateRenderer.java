...
/**
 * Renderer for a UIInput or UIOutput Date.
 */
public class InputOutputDateRenderer extends com.sun.faces.renderkit.html_basic.DateRenderer {

    public InputOutputDateRenderer() {
    }

    protected void getEndTextToRender(FacesContext context, UIComponent component, String currentValue, StringBuffer buffer) {
        getEndTextToRender("date", context, component, currentValue, buffer);
    }

    /**
     * Centralize here the rendering code for Date, Time and DateTime since we can't use derivation.
     */
    static void getEndTextToRender(String elementName, FacesContext context, UIComponent component, String currentValue, StringBuffer buffer) {
        // Handle two cases whether the component is an input or an output
