...
<!--                        </table>-->
                        ...
                        <xforms:group ref="claim:form/claim:vehicles">
                            <table>
                                <tr>
                                    <th align="left">California Plate / CF / Placard No.</th>
                                    <th align="left">VIN</th>
                                </tr>
                                <xforms:repeat nodeset="claim:vehicle" id="vehicleSet">
                                    <tr>
                                        <td>
                                            <xforms:input ref="claim:plate-no">
                                                <xforms:hint>Birth Date</xforms:hint>
                                                <xforms:help>Please enter a birth date here (e.g. 1970-02-25)</xforms:help>
                                            </xforms:input>
                                        </td>
                                        <td>
                                            <xforms:input ref="claim:vin">
                                        ...
                                        <td>
                                            <xforms:submit>
                                                ...
                                                <xforms:delete nodeset="/form/document/claim:form/claim:vehicles/claim:vehicle" at="index('vehicleSet')"/>
                                            </xforms:submit>
                                        </td>
                                    </tr>
                                </xforms:repeat>
                                <tr>
                                    <td colspan="2">
                                        <xforms:submit>
                                            ...
                                            <xforms:insert nodeset="/form/document/claim:form/claim:vehicles/claim:vehicle" at="last()" position="after"/>
                                        </xforms:submit>
                                    </td>
                                </tr>
                            </table>
