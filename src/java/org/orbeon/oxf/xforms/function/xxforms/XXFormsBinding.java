...
public class XXFormsBinding extends XFormsFunction {
    ...
    public SequenceIterator iterate(XPathContext xpathContext) throws XPathException {
        ...
        final String controlId = (controlIdExpression == null) ? null : XFormsUtils.namespaceId(getContainingDocument(xpathContext), controlIdExpression.evaluateAsString(xpathContext));

        if (controlId == null)
            return EmptyIterator.getInstance();

        final Object object = getControls(xpathContext).resolveObjectById(null, controlId);
