 ...
 */
public class OPSServletContextListener implements ServletContextListener {
    ...
    private void initializeDelegate(WebAppExternalContext webAppExternalContext) {
        try {
            if (servletContextListenerDelegate == null) {
                Class delegateServletClass = OXFClassLoader.getClassLoader(webAppExternalContext).loadClass(OPSServletContextListener.class.getName() + OXFClassLoader.DELEGATE_CLASS_SUFFIX);
