...
object XFormsNames {
  ...
  def xxfQName      (name: String): QName = QName(name, XXFORMS_NAMESPACE_SHORT)
  ...
  val XXBL_TYPE_QNAME                       = xxblQName("type")
  val XXBL_CONSTRAINT_QNAME                 = xxblQName("constraint")
  ...
  val XXFORMS_KEEP_MIP_QNAME                  = xxfQName("keep-mip")
