...
val DefaultOrbeonFormsVersion        = "2026.1-SNAPSHOT"
...
val HttpComponents5Version           = "5.6.4"
val Log4j2Version                    = "2.25.4"
val CommonsIoVersion                 = "2.15.1"
val OpenHtmlToPdfVersion             = "1.1.78"
val PdfBoxVersion                    = "3.0.8-orbeon.1" // Patched version with PDFBOX-6220 backport
...
val AwsNettyVersion                  = "4.2.16.Final"
...
val WildFlyElytronHttpOidcVersion    = "2.9.2.SP1"
...
val RedisLibraryDependencies = Seq(
  "org.redisson"                % "redisson-all"                    % "3.52.0",
  "org.redisson"                % "redisson-tomcat-9"               % "3.52.0",
...
lazy val core = (project in file("src"))
  ...
  .configs(DebugTest)
  .settings(scala2CommonSettings*)
  .settings(unmanagedJarsSettings*)
  .settings(commonScalaJvmSettings)
  .settings(inConfig(DebugTest)(Defaults.testSettings)*)
  .settings(assetsSettings*)
  .settings(
...
lazy val orbeonWarJVM = orbeonWar.jvm
  ...
  .settings(WebJarPatcher.settings*)
  .settings(
...
lazy val dbToS3AttachmentMigration = (project in file("tools/db-to-s3-attachment-migration"))
  ...
  .settings(
    ...
    libraryDependencies                 += "mysql"                    % "mysql-connector-java" % "8.0.33"          % DatabaseTest,
    libraryDependencies                 += "com.oracle.database.jdbc" % "ojdbc11"              % OracleJdbcVersion % DatabaseTest,
    libraryDependencies                 += "com.ibm.db2"              % "jcc"                  % "12.1.5.0"        % DatabaseTest,
    libraryDependencies                 += "com.microsoft.sqlserver"  % "mssql-jdbc"           % "13.6.0.jre11"   % DatabaseTest,
