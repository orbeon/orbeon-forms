...
public class OXFPortlet extends GenericPortlet {
    ...
    public void init() throws PortletException {
        try {
            ...
            Class delegatePortletClass = OXFClassLoader.getClassLoader(webAppExternalContext).loadClass(OXFPortlet.class.getName() + OXFClassLoader.DELEGATE_CLASS_SUFFIX);
