...
public class OPSServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            ...
            Class delegateServletClass = OXFClassLoader.getClassLoader(webAppExternalContext).loadClass(OPSServlet.class.getName() + OXFClassLoader.DELEGATE_CLASS_SUFFIX);
