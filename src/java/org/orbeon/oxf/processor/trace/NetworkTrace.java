...
//                    final TraceEntry traceEntry = (TraceEntry) iterator.next();
//                    final String systemId = traceEntry.systemId != null ? traceEntry.systemId : "";
//                    oos.writeObject(systemId);
//                    oos.writeInt(traceEntry.line);
//                    oos.writeLong(traceEntry.start);
//                    oos.writeLong(traceEntry.end);
//
//                }
