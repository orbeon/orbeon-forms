...
public class ActionResponseImpl extends PortletResponseImpl implements ActionResponse {
    ...
    public ActionResponseImpl(int portletId, ExternalContext externalContext, PortletRequest portletRequest, PortletURLImpl.RequestParameters requestParameters) {
