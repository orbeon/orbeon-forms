    ...
    <body>
        <div id="maincontent">
            ...
            <xforms:group ref="/form">
                <h2 style="margin-top: 0; clear: both">Available Documents</h2>
                <table class="gridtable">
                    ...
                    <xsl:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xforms:submit>
                                            ...
                                            <xforms:setvalue ref="action">show-pdf</xforms:setvalue>
                                            <xforms:setvalue ref="document-id"><xsl:value-of select="."/></xforms:setvalue>
                                        </xforms:submit>
                                    </td>
                                    <td>
                        ...
                        <xsl:otherwise>
                            <tr>
                                <td colspan="5"><i>No document found.<br/>Please press the "Import
