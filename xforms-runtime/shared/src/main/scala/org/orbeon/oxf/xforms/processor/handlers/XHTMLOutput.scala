...
object XHTMLOutput {
  ...
  private val findHandlerTakeElementAnalysisPf: PartialFunction[ElementHandlerInput, ElementHandler[HandlerContext]] = {
    ...
    case (ns @ XF,  ln @ "group"           , qn, atts, c: GroupControl    , hc)                                                      => new XFormsGroupDefaultHandler   (ns, ln, qn, atts, c, hc)
    ...
    case (ns @ XF,  ln @ "switch"          , qn, atts, c: SwitchControl   , hc)                                                      => new XFormsGroupDefaultHandler   (ns, ln, qn, atts, c, hc)
    case (ns @ XF,  ln @ "input"           , qn, atts, c: InputControl    , hc)                                                      => new XFormsInputHandler          (ns, ln, qn, atts, c, hc)
