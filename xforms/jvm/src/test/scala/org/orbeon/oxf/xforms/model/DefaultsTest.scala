...
class DefaultsTest extends DocumentTestBase with XFormsSupport with AssertionsForJUnit {

  @Test def defaultValueAndInsert(): Unit = {
  ...
  @Test def defaultValueAndSubmission(): Unit = {
