...
public class NewCacheImpl implements Cache {
    ...
    public NewCacheImpl(String cacheName, int maxSize) {
    ...
    public synchronized void remove(PropertyContext context, CacheKey key) {
    ...
    public synchronized void setMaxSize(PropertyContext context, int maxSize) {
    ...
    public Iterator iterateCacheKeys(PropertyContext context) {
        return keyToEntryMap.keySet().iterator();
    }

    public Iterator iterateCacheObjects(PropertyContext context) {
