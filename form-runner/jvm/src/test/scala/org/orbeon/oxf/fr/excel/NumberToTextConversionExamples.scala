...
object NumberToTextConversionExamples {
  ...
  object ExampleConversion {
    ...
    def apply(rawDoubleBits: Long, javaRendering: String, excelRendering: String): ExampleConversion = {
      val d = jl.Double.longBitsToDouble(rawDoubleBits)
      if ("NaN" == javaRendering) {
        if (! jl.Double.isNaN(d))
        ...
        val javaToStringOk = javaRendering == jl.Double.toString(d)
        val javaParseOk = javaRendering.toDouble == d
        if (! javaToStringOk || ! javaParseOk) {
          val msgA = "Specified rawDoubleBits " + ExampleConversion.doubleToHexString(d) + " encodes to double '" + d + "'."
          val msgB = "Specified javaRendering '" + javaRendering + "' parses as double with rawDoubleBits " + ExampleConversion.doubleToHexString(javaRendering.toDouble)
  ...
  private def ec(rawDoubleBits: Long, javaRendering: String, excelRendering: String) =
    ExampleConversion(rawDoubleBits, javaRendering, excelRendering)
  ...
  val Examples = List(
    ...
    ec(0x54820FE0BA17F921L, "1.23456789012375E99", "1.2345678901238E+99"), // transitions around the E98,E99,E100 boundaries
    ...
    ec(0x2B617F7D4ED8C2C0L, "9.999999999999744E-100", "9.9999999999997E-100"), // small numbers
    ...
    ec(0x359DEE7A4AD4B81FL, "2.0E-50", "2E-50"), // large numbers
    ...
    ec(0x4A611B0EC57E649AL, "2.0E50", "2E+50"), // range extremities
    ...
    ec(0x0000000000000001L, "4.9E-324", "0"), // infinity
    ec(0x7FF0000000000000L, "Infinity", "1.7976931348623E+308"),
    ec(0xFFF0000000000000L, "-Infinity", "1.7976931348623E+308"), // shortening due to rounding
    ...
    ec(0x3BCD291DEF868C89L, "1.234999999999999E-20", "1.235E-20"), // carry up due to rounding
    ...
    ec(0xBBFD83C94FB6D2ABL, "-9.999999999999999E-20", "-1E-19"), // NaNs
