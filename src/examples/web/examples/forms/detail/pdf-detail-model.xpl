    ...
    <p:processor name="oxf:pdf-template">
        ...
        <p:input name="model">
            <config xmlns:dmv="http://orbeon.org/oxf/examples/dmv">
                ...
                <field left-position="108.3" top-position="223" spacing="15.9" font-family="Courier" font-size="14" size="1" ref="/document-info/document/dmv:form/dmv:address-information/dmv:voter-address-change/dmv:change-address"/>
                ...
                <field left-position="519" top-position="318" spacing="15.9" font-family="Courier" font-size="14" size="5" ref="/document-info/document/dmv:form/dmv:address-information/dmv:address[@type = 'residence']/dmv:zip"/>
                ...
                <field left-position="519" top-position="417" spacing="15.9" font-family="Courier" font-size="14" size="5" ref="/document-info/document/dmv:form/dmv:address-information/dmv:address[@type = 'mailing']/dmv:zip"/>

                <field left-position="108.5" top-position="465" spacing="15.9" font-family="Courier" font-size="14" size="8" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[1]/dmv:plate-number"/>
                <field left-position="255" top-position="465" spacing="15.9" font-family="Courier" font-size="14" size="17" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[1]/dmv:vin"/>
                <field left-position="549" top-position="465" spacing="15.9" font-family="Courier" font-size="14" size="1" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[1]/dmv:leased"/>
                <field left-position="108.5" top-position="489" spacing="15.9" font-family="Courier" font-size="14" size="8" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[2]/dmv:plate-number"/>
                <field left-position="255" top-position="489" spacing="15.9" font-family="Courier" font-size="14" size="17" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[2]/dmv:vin"/>
                <field left-position="549" top-position="489" spacing="15.9" font-family="Courier" font-size="14" size="1" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[2]/dmv:leased"/>
                <field left-position="108.5" top-position="512.5" spacing="15.9" font-family="Courier" font-size="14" size="8" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[3]/dmv:plate-number"/>
                <field left-position="255" top-position="512.5" spacing="15.9" font-family="Courier" font-size="14" size="17" ref="/document-info/document/dmv:form/dmv:vehicle-information/dmv:vehicles/dmv:vehicle[3]/dmv:vin"/>
