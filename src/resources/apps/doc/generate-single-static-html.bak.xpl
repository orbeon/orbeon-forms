...
<!--                            </tfoot>-->
    ...
    <p:processor name="oxf:qname-converter">
        ...
        <p:output name="data" id="final-xhtml"/>
    </p:processor>

    <p:processor name="oxf:xslt">
        <p:input name="config" href="file:///c:/html2fo.xsl"/>
        <p:input name="data" href="#final-xhtml"/>
        <p:output name="data" id="final-fo"/>
    </p:processor>
    ...
    <p:processor name="oxf:xml-converter">
        ...
        <p:input name="data" href="#final-fo"/>
