...
class XercesSAXParser extends org.orbeon.apache.xerces.parsers.SAXParser {
    ...
    public static OrbeonParserConfiguration makeConfig(ParserConfiguration parserConfiguration) {
    ...
    public XercesSAXParser(ParserConfiguration parserConfiguration) {
