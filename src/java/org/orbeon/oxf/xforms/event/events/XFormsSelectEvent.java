...
public class XFormsSelectEvent extends XFormsUIEvent {
    ...
    public XFormsSelectEvent(XFormsContainingDocument containingDocument, XFormsEventTarget targetObject) {
        super(containingDocument, XFormsEvents.XFORMS_SELECT, (XFormsControl) targetObject, true, false);
    }
    public XFormsSelectEvent(XFormsContainingDocument containingDocument, XFormsEventTarget targetObject, String itemValue) {
