                                        ...
                                        SELECT created, last_modified_time, document_id, username, groupname, draft
                                            ...
                                            <xsl:for-each select="/search/query[@path]">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:when test="/search/provider = 'db2'        ">, XMLCAST(XMLQUERY('declare namespace xh="http://www.w3.org/1999/xhtml";declare namespace xf="http://www.w3.org/2002/xforms";$XML<xsl:value-of select="f:escape-sql(f:escape-lang(@path, /*/lang))"/>/text()') AS VARCHAR(4000))</xsl:when>
