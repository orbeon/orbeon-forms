 ...
 */
public class TEMPOPSXFormsFilter implements Filter {
...
//            }
//
//            servletContext.log("OPSXFormsFilter DEBUG: " + "new session: " + Boolean.toString(session.isNew())
//                    + "; session id: " + session.getId() + "; requested session id: " + httpRequest.getRequestedSessionId()
//                    + "; incoming JSESSIONID: " + incomingSessionCookie);
        }
