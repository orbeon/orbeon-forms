CREATE TABLE orbeon_form_definition (
    ...
    xml                 XMLTYPE                      ,
    xml_clob            CLOB                         ,
    CONSTRAINT orbeon_form_definition_pk PRIMARY KEY (id)
...
CREATE TABLE orbeon_form_definition_attach (
    ...
    file_content        BLOB                         ,
    hash_algorithm      VARCHAR2(255 CHAR)           ,
    hash_value          VARCHAR2(255 CHAR)           ,
    CONSTRAINT orbeon_form_definition_attach_pk PRIMARY KEY (id)
);
...
CREATE TABLE orbeon_form_data_attach (
    ...
    hash_algorithm      VARCHAR2(255 CHAR)           ,
    hash_value          VARCHAR2(255 CHAR)           ,
    CONSTRAINT orbeon_form_data_attach_pk PRIMARY KEY (id)
);
...
CREATE TABLE orbeon_organization (
    ...
    CONSTRAINT orbeon_organization_pk PRIMARY KEY (id, pos)
);
...
CREATE TABLE orbeon_i_current (
    ...
    CONSTRAINT orbeon_i_current_pk PRIMARY KEY (id)
);
...
CREATE TABLE orbeon_i_control_text (
    ...
    val                 CLOB                  NOT NULL,
    FOREIGN KEY         (data_id)             REFERENCES orbeon_form_data(id),
    CONSTRAINT orbeon_i_control_text_pk PRIMARY KEY (id)
);
