...
public class XFormsConstants {
    ...
    public static final QName XFORMS_TYPE_QNAME = new QName("type", XFORMS_NAMESPACE);
    public static final QName XFORMS_RELEVANT_QNAME = new QName("relevant", XFORMS_NAMESPACE);
    public static final QName XFORMS_REQUIRED_QNAME = new QName("required", XFORMS_NAMESPACE);
    ...
    public static final QName XFORMS_PARAM_QNAME = new QName("param", XFORMS_NAMESPACE);
    public static final QName XFORMS_BODY_QNAME = new QName("body", XFORMS_NAMESPACE);
