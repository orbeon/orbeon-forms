...
val SaxonJsVersion                   = "10.0.0.76-SNAPSHOT"
...
val ScalaXmlVersion               = "2.2.0"  // see https://github.com/orbeon/orbeon-forms/issues/4927
...
val LiferayPortalKernelVersion    = "97.0.0"
...
val CoreLibraryDependencies = Seq(
  ...
  "org.bouncycastle"            % "bcmail-jdk18on"                  % "1.75", // for `openpdf`, also pulls `bcprov` and `bcpkix`
