...
public class PropertyStore {
    ...
    private final Map processorPropertySets = new HashMap();

    public static final Map SUPPORTED_TYPES = new HashMap();
    ...
    public PropertySet getProcessorPropertySet(final QName processorQName) {
        PropertySet propertySet = (PropertySet) processorPropertySets.get(processorQName);
        if (propertySet == null) {
