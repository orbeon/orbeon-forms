...
/**
 * Renderer for a UISelectBoolean Checkbox.
 */
public class SelectbooleanCheckboxRenderer extends com.sun.faces.renderkit.html_basic.CheckboxRenderer {
    ...
    protected void getEndTextToRender(FacesContext context, UIComponent component, String currentValue, StringBuffer buffer) {
        ...
        // Render checkbox element, class and id
        buffer.append(XmlRenderKitUtils.getStartElement("selectboolean_checkbox"));
        buffer.append(XmlRenderKitUtils.getAttribute("class", (String) component.getAttribute("selectbooleanClass")));
        buffer.append(XmlRenderKitUtils.getAttribute("id", component.getClientId(context)));

        // Set if the checkbox is selected or not
        buffer.append(XmlRenderKitUtils.getAttribute("selected", currentValue.equals("true") ? "true" : "false"));
