 ...
 */
public class NewXFormsServer extends ProcessorImpl {

    static public Logger logger = LoggerFactory.createLogger(NewXFormsServer.class);
    ...
    private void doIt(final PipelineContext pipelineContext, ContentHandler contentHandler) {
        ...
        try {
            ...
            if (contentHandler != null) {
                outputResponse(containingDocument, pipelineContext, contentHandler, requestPageGenerationId, externalContext, xformsState);
            }
        } catch (Throwable e) {
    ...
    private void outputResponse(XFormsContainingDocument containingDocument, PipelineContext pipelineContext, ContentHandler contentHandler, String requestPageGenerationId, ExternalContext externalContext, XFormsState xformsState) {
