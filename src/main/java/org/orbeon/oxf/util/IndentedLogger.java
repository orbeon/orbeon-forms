...
public class IndentedLogger {
    ...
    public void logInfo(String type, String message, Throwable throwable) {
        log(Level.INFO, indentation.indentation, type, message, "throwable", OrbeonFormatter.format(throwable));
    }
    ...
    public void logError(String type, String message, Throwable throwable) {
        log(Level.ERROR, indentation.indentation, type, message, "throwable", OrbeonFormatter.format(throwable));
    }
