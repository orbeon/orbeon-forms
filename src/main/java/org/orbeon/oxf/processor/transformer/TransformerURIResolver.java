...
public class TransformerURIResolver implements URIResolver {
     ...
     */
    public TransformerURIResolver(ProcessorImpl processor, PipelineContext pipelineContext, String prohibitedInput, ParserConfiguration parserConfiguration) {
     ...
     */
    public TransformerURIResolver(ProcessorImpl processor, PipelineContext pipelineContext, String prohibitedInput, ParserConfiguration parserConfiguration, String mode) {
    ...
    public SAXSource resolve(String href, String base) throws TransformerException {
        ...
        XMLReader xmlReader;
        {
            ...
            if (prohibitedInput != null && prohibitedInput.equals(inputName)) {
                ...
                final Processor urlGenerator = new URLGenerator(url, null, false, null, false, false, parserConfiguration, true, mode, null, null, null, cacheUseLocalCache, false);
