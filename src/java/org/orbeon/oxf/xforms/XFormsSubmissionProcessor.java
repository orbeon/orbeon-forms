 ...
 * </params>
 */
public class XFormsSubmissionProcessor extends ProcessorImpl {
    ...
    public XFormsSubmissionProcessor() {
...
//                        });
                        ...
                        instance = new XFormsInstance(pipelineContext, Dom4jUtils.NULL_DOCUMENT, null);//TEMP FIXME XXXX

                    } else {
                        // No instance submitted, return null document
                        instance = new XFormsInstance(pipelineContext, Dom4jUtils.NULL_DOCUMENT, null);
                    }
                }
