...
public class XMLConstants {
    ...
    public static final String BASE64BINARY_TYPE = XSD_PREFIX + ":base64Binary";
    public static final String ANYURI_TYPE = XSD_PREFIX + ":anyURI";

    public static final Namespace OXF_PROCESSORS_NAMESPACE = new Namespace("oxf", "http://www.orbeon.com/oxf/processors");
