...
<xhtml:html xmlns:xforms="http://www.w3.org/2002/xforms"
        ...
        <xforms:model>
            <xforms:instance>
                <number>
                    ...
                    <guess/>
                    <display feedback="" too-low="" too-high="" correct=""/>
                </number>
            </xforms:instance>
            <xforms:bind nodeset="/number/display/@feedback" relevant="/number/guess != ''"/>
            <xforms:bind nodeset="/number/display/@too-low" relevant="/number/answer > /number/guess"/>
            <xforms:bind nodeset="/number/display/@too-high" relevant="/number/guess > /number/answer"/>
            <xforms:bind nodeset="/number/display/@correct" relevant="/number/answer = /number/guess"/>
        </xforms:model>
    ...
    <xhtml:body>
        ...
        <xhtml:div>
            ...
            <xforms:input ref="guess" class="guess"/>
            <xforms:trigger>
                <xforms:label>Go</xforms:label>
            </xforms:trigger>
            <xforms:group ref="display/@feedback">
                <xhtml:span class="feedback">
                    <xforms:group ref="../@too-low">
                        <xforms:output value="/number/guess"/>&#160;is a bit too low.</xforms:group>
                    <xforms:group ref="../@too-high"><xforms:output value="/number/guess"/>&#160;is a tat too high.</xforms:group>
                    <xforms:group ref="../@correct"><xforms:output value="/number/guess"/>&#160;is the right answer. Congratulations!</xforms:group>
                </xhtml:span>
            </xforms:group>
        </xhtml:div>
        <!-- Feedback -->
