...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="annotated-data" select="document('oxf:annotated-data')/*" as="element()"/>
    ...
    <xsl:variable name="anchors" select="$xhtml-data-hidden//*[@portlet:is-portlet-content = 'true']//(xhtml:a|a)[@href and not(@f:url-type = 'resource')]" as="element()*"/>
