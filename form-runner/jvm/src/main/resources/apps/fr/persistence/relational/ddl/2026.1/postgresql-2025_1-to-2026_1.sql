ALTER TABLE orbeon_form_definition ADD COLUMN id SERIAL;
...
ALTER TABLE orbeon_form_definition_attach ADD COLUMN id SERIAL;
...
ALTER TABLE orbeon_form_data_attach ADD COLUMN id SERIAL;
...
ALTER TABLE orbeon_i_current ADD COLUMN id SERIAL;
...
ALTER TABLE orbeon_i_control_text ADD COLUMN id SERIAL;
