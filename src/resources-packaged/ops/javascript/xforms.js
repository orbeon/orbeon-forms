...
ORBEON.xforms.Controls = {
    ...
    _getControlLabel: function(control, className) {
        ...
        var labelId = ORBEON.util.Utils.appendToEffectiveId(control.id, classNameToId[className]);
    ...
    getLabelMessage: function(control) {
        if (ORBEON.util.Dom.hasClass(control, "xforms-trigger")
            ...
            var labelElement = ORBEON.xforms.Controls._getControlLabel(control, "label");
    ...
    getHelpMessage: function(control) {
        var helpElement = ORBEON.xforms.Controls._getControlLabel(control, "help");
    ...
    setValid: function(control, newValid) {
        ...
        var alertElement = ORBEON.xforms.Controls._getControlLabel(control, "alert");
    ...
    setRelevant: function(control, isRelevant) {
        ...
        if (ORBEON.util.Dom.hasClass(control, "xforms-group-begin-end")) {
            ...
            var elementsToUpdate = [ control,
                ORBEON.xforms.Controls._getControlLabel(control, "label"),
                ORBEON.xforms.Controls._getControlLabel(control, "alert")
            ];
            // Also show help if message is not empty
            if (!isRelevant || (isRelevant && ORBEON.xforms.Controls.getHelpMessage(control) != "")) {
                elementsToUpdate.push(ORBEON.xforms.Controls._getControlLabel(control, "help"));
                elementsToUpdate.push(ORBEON.xforms.Controls._getControlLabel(control, "help-image"));
            }
            // Also show hint if message is not empty
            if (!isRelevant || (isRelevant && ORBEON.xforms.Controls.getHintMessage(control) != ""))
                elementsToUpdate.push(ORBEON.xforms.Controls._getControlLabel(control, "hint"));
    ...
    getHintMessage: function(control) {
        if (ORBEON.util.Dom.hasClass(control, "xforms-trigger")) {
            ...
            var hintElement = ORBEON.xforms.Controls._getControlLabel(control, "hint");
            ...
            if (targetControlElement != null) {
                ...
                if (!ORBEON.util.Dom.hasClass(targetControlElement, "xforms-visited")) {
                    ...
                    function afterAjaxResponseAfterBlur() {
                        ...
                        var alertLabel = ORBEON.xforms.Controls._getControlLabel(targetControlElement, "alert");
...
//                XFORMS_DELAY_BEFORE_CLOSE_MINIMAL_DIALOG_IN_MS);
    ...
    click: function(event) {
        ...
        if (target != null && ORBEON.util.Dom.hasClass(target, "xforms-output")) {
            ...
            var control = target.id.indexOf("$$i") != -1
                ? YAHOO.util.Dom.get(target.id.substring(0, target.id.length - "$$i".length))
                : target.parentNode;
                                    ...
                                    for (var j = 0; j < controlElementslength; j++) {
                                        ...
                                        if (!isStaticReadonly && staticReadonly == "true") {
                                            if (isLeafControl) {
                                                ...
                                                // Remove alert
                                                var alertElement = ORBEON.xforms.Controls._getControlLabel(newDocumentElement, "alert");
                                                if (alertElement != null)
                                                    parentElement.removeChild(alertElement);
                                                // Remove hint
                                                var hintLabel = ORBEON.xforms.Controls._getControlLabel(newDocumentElement, "hint");
                                                if (hintLabel != null)
