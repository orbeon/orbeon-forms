...
class XercesSAXParser extends orbeon.apache.xerces.parsers.SAXParser
{
    ...
    static XIncludeParserConfiguration makeConfig() {
        final XIncludeParserConfiguration ret = new XIncludeParserConfiguration();
    ...
    public XercesSAXParser( /*final long strt*/ ) {
        super( makeConfig() );
        //System.out.println( "SAXParser<init>(config) : " + ( System.currentTimeMillis() - strt ) );
    }
     /*
