...
public class RenderResponseImpl extends PortletResponseImpl implements RenderResponse {
    ...
    public RenderResponseImpl(int portletId, ExternalContext externalContext, PortletRequest portletRequest, StreamInterceptor streamInterceptor) {
        super(portletId, externalContext, portletRequest);
    ...
    private PortletURL createURL(int urlType) {
        PortletURL portletURL = new PortletURLImpl(portletId, getURLPrefix(), urlType);
        try {
