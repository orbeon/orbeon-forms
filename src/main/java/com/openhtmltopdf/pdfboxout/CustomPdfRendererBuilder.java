...
public class CustomPdfRendererBuilder extends BaseRendererBuilder<CustomPdfRendererBuilder, PdfRendererBuilderState> {
...
//    }
    ...
    public CustomPdfBoxRenderer buildPdfRenderer(java.util.function.Function<PdfBoxOutputDevice, PdfBoxUserAgent> createUserAgent) {
        ...
        try {
            return buildPdfRenderer(d, createUserAgent);
        } catch (Throwable e) {
     ...
     */
    public CustomPdfRendererBuilder toStream(OutputStream out) {
        state._os = out;
        return this;
    }
     ...
     */
    public CustomPdfRendererBuilder usePdfVersion(float version) {
     ...
     */
    public CustomPdfRendererBuilder usePdfAConformance(PdfRendererBuilder.PdfAConformance pdfAConformance) {
     ...
     *
     * @see CustomPdfRendererBuilder#usePdfUaAccessibility
     * @deprecated Misspelled method name
     */
    @SuppressWarnings("SpellCheckingInspection")
    @Deprecated
    public CustomPdfRendererBuilder usePdfUaAccessbility(boolean pdfUaAccessibility) {
     ...
     * Whether to conform to PDF/UA or Accessible PDF. False by default.
     */
    public CustomPdfRendererBuilder usePdfUaAccessibility(boolean pdfUaAccessibility) {
     ...
     */
    public CustomPdfRendererBuilder useColorProfile(byte[] colorProfile) {
     ...
     */
    public CustomPdfRendererBuilder usePDDocument(PDDocument doc) {
     ...
     */
    public CustomPdfRendererBuilder useFont(PDFontSupplier supplier, String fontFamily, Integer fontWeight,
     ...
     */
    public CustomPdfRendererBuilder useFont(PDFontSupplier supplier, String fontFamily) {
     ...
     * @return this for method chaining
     */
    public CustomPdfRendererBuilder withProducer(String producer) {
    ...
    /**
	  ...
	  */
	  public CustomPdfRendererBuilder useHyphenation(Hyphenator hyphenator) {
     ...
     */
    public CustomPdfRendererBuilder useCacheStore(PdfRendererBuilder.CacheStore which, FSCacheEx<String, FSCacheValue> cache) {
     ...
     * @return this for method chaining.
     */
    public CustomPdfRendererBuilder usePageSupplier(PageSupplier pageSupplier) {
     ...
     * @return this for method chaining.
     */
    public CustomPdfRendererBuilder useNamespaceHandler(NamespaceHandler namespaceHandler) {
