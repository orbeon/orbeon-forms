...
public class HTMLConverter extends TextConverterBase {
    ...
    protected boolean readInput(PipelineContext context, final ContentHandler contentHandler, ProcessorInput input, Config config, Writer writer) {
        ...
        readInputAsSAX(context, input,  new StripNamespaceContentHandler(identity) {
     ...
     * way.
     */
    protected static class StripNamespaceContentHandler extends SimpleForwardingContentHandler {
        public StripNamespaceContentHandler(ContentHandler contentHandler) {
