            ...
            final Item contextItem;
            {
                if (bindId != null) {
                    ...
                    final XFormsObject o =
                        resolutionScopeContainer.resolveObjectById(sourceEffectiveId, bindId, baseBindingContext.singleItemOpt());
...
//                    }
            ...
            // Push new context
            final String bindingElementId = (bindingElement == null) ? null : org.orbeon.oxf.xforms.XFormsUtils.getElementId(bindingElement);
