...
import org.orbeon.saxon.number.{AbstractNumberer, Numberer_zhHant}
import org.junit.Test
import org.scalatestplus.junit.AssertionsForJUnit

/**
 * Tests for numberer class for Traditional Chinese (BCP 47: {@code zh-Hant}).
 */
class Numberer_zhHantTest extends AssertionsForJUnit {

  private val N = new Numberer_zhHant
  ...
  @Test def testLargeUnits(): Unit = {
    check(10000L, "一萬", "第一萬")
    check(10001L, "一萬一", "第一萬一")
    check(10010L, "一萬十", "第一萬十")
    check(12345L, "一萬二千三百四十五", "第一萬二千三百四十五")
    check(100000L, "十萬", "第十萬")
    check(1000000L, "一百萬", "第一百萬")
    check(1000001L, "一百萬一", "第一百萬一")
    check(100000000L, "一億", "第一億")
    check(100000001L, "一億零一", "第一億零一")
    check(100000010L, "一億零十", "第一億零十")
  }
  ...
  @Test def testDayName(): Unit = {
    ...
    assert("週一" === N.dayName(1, 2, 2))
    assert("週" === N.dayName(1, 1, 2))
    assert("週一  " === N.dayName(1, 4, 2))
  }
}
